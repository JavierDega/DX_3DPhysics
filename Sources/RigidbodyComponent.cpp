...
RigidbodyComponent::RigidbodyComponent( float radius, float mass, bool isKinematic, XMVECTOR color)
	: m_mass(mass), m_isKinematic(isKinematic), m_force(Vector3::Zero), m_acceleration(Vector3::Zero), m_velocity(Vector3::Zero), m_torque(Vector3::Zero), m_angularVelocity(Vector3::Zero)
{
